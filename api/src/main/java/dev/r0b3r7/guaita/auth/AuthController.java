...
class AuthController {
  ...
  // IP del cliente SIN confiar en un X-Forwarded-For arbitrario (sería spoofeable -> bypass del
  // rate
  ...
  // IP real del cliente. La app solo escucha en 127.0.0.1 (tras nginx); nginx limit_req es la
  // barrera
