 ...
 * aquí como 401 (no 500), porque el resource server lanza una AuthenticationException. El JSON se
 * escribe a mano (título y detalle son constantes) para no depender de un bean ObjectMapper.
 */
@Component
